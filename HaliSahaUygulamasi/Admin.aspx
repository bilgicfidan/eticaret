<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="HaliSahaUygulamasi.Admin1" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
    <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Yönetici Paneli</h1>
            </div>
        </div>
        <!--/.row-->
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-shopping-cart color-blue"></em>
							...
							<div class="text-muted">Yeni Sunular</div>
						</div>
					</div>
				</div>
				<%--<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-orange panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
							...
							<div class="text-muted">Yeni Üyeler</div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
